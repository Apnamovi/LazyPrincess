...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "Name: <i>{file_caption}@LusiFilms</i> \n\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n👉 <b>Join Now : @LusiFilms</b> 👈")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "Name: <i>{file_caption}@LusiFilms</i> \n\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n👉 <b>Join Now : @LusiFilms</b> 👈")
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'f99384c91447757f420')
